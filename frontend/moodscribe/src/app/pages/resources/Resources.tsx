  ...
  return (
    <>
        ...
        <form className='w-full max-w-md mx-1'>
          ...
          <div className='relative'>
            ...
            <input
              ...
              placeholder='Найдите больше советов по психическому здоровью...'
              required
      ...
      <div className='container mx-auto max-w-2xl text-white mt-6 mb-10 px-4'>
        ...
        <p className='py-6'>
          Изучите нашу подборку статей и рекомендаций для поддержания психическо
          го здоровья. Найдите полезные советы, стратегии преодоления трудностей
          и методы самопомощи.
        </p>
